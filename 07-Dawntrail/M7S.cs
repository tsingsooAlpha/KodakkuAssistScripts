    ...
    public class M7S_Script
    {
        ...
        */
        ...
        public void P1_PollenGuideDraw1(Event @event, ScriptAccessory accessory)
        {
            ...
            // P1_IsLeftDownSafe = isLeftDownSafe; // 记录左下角安全区
            ...
            switch (accessory.GetMyRole())
            {
                ...
                case EX.PlayerRoleEnum.D2:
                    myStartPos = WalkthroughType switch
                    {
                        WalkthroughEnum.MMW_SPJP => isLeftDownSafe ? DataM7S.P1_FieldCenter + new Vector3(7, 0, 7) : DataM7S.P1_FieldCenter + new Vector3(-7, 0, 7),
                        _ => myStartPos,
                    };
                    break;
                case EX.PlayerRoleEnum.H1:
                    myStartPos = WalkthroughType switch
                    {
                        WalkthroughEnum.MMW_SPJP => isLeftDownSafe ? DataM7S.P1_FieldCenter + new Vector3(-17, 0, 17) : DataM7S.P1_FieldCenter + new Vector3(17, 0, 17),
                        _ => myStartPos,
                    };
                    break;
        ...
        [ScriptMethod(name: "P1 荆棘蔓延 危险区绘制 Roots Of Evil Dangerous Zone Draw",
            eventType: EventTypeEnum.StartCasting,
        ...
        public void P1_SinisterSeedsBlossomGuideDraw(Event @event, ScriptAccessory accessory)
        {
            ...
            if (count != 4 || @event.SourcePosition.Y < -100 || @event.SourcePosition.Z < 50 || LashingLariatCastingCount > 0) return;
                ...
                case EX.PlayerRoleEnum.MT:
                    switch (WalkthroughType)
                    {
                        case WalkthroughEnum.MMW_SPJP:
                            ...
                            {
                                myStartPos = DataM7S.P1_FieldCenter + new Vector3(-DataM7S.P1_NailOffset_In.X, 0, -DataM7S.P1_NailOffset_In.Z);
                            }
                            else
                            {
                ...
                case EX.PlayerRoleEnum.H1:
                    switch (WalkthroughType)
                    {
                        case WalkthroughEnum.MMW_SPJP:
                            ...
                            {
                                myStartPos = DataM7S.P1_FieldCenter + new Vector3(0, 0, 18);
                                myModPos = DataM7S.P1_FieldCenter + new Vector3(0, 0, 9);
                            }
                            myStackPos = DataM7S.P1_FieldCenter + new Vector3(-6, 0, 0);
                            myEndPos = DataM7S.P1_FieldCenter + new Vector3(-18, 0, 0);
        ...
        */
        ...
        public void P1P3_ItCameFromTheDirtGuideDraw(Event @event, ScriptAccessory accessory)
        {
            ...
            {
                case EX.PlayerRoleEnum.MT:
                    myOffset = WalkthroughType switch
                    {
                        WalkthroughEnum.MMW_SPJP => offSetFront,
                        _ => myOffset,
                    };
                    break;
                case EX.PlayerRoleEnum.ST:
                    myOffset = WalkthroughType switch
                    {
                        WalkthroughEnum.MMW_SPJP => offSetBack,
                        _ => myOffset,
                    };
                    break;
                case EX.PlayerRoleEnum.H1:
                    myOffset = WalkthroughType switch
                    {
                        WalkthroughEnum.MMW_SPJP => offSetLeft,
                        _ => myOffset,
                    };
                    break;
                case EX.PlayerRoleEnum.H2:
                    myOffset = WalkthroughType switch
                    {
                        WalkthroughEnum.MMW_SPJP => offSetRight,
                        _ => myOffset,
                    };
                    break;
                case EX.PlayerRoleEnum.D1:
                    myOffset = WalkthroughType switch
                    {
                        WalkthroughEnum.MMW_SPJP => offSetBackLeft,
                        _ => myOffset,
                    };
                    break;
                case EX.PlayerRoleEnum.D2:
                    myOffset = WalkthroughType switch
                    {
                        WalkthroughEnum.MMW_SPJP => offSetBackRight,
                        _ => myOffset,
                    };
                    break;
                case EX.PlayerRoleEnum.D3:
                    myOffset = WalkthroughType switch
                    {
                        WalkthroughEnum.MMW_SPJP => offSetFrontLeft,
                        _ => myOffset,
                    };
                    break;
                case EX.PlayerRoleEnum.D4:
                    myOffset = WalkthroughType switch
                    {
                        WalkthroughEnum.MMW_SPJP => offSetFrontRight,
                        _ => myOffset,
                    };
                    break;
            }
        ...
        {
            Vector3 myEndPos = Vector3.Zero;
            Vector3 bossPos = @event.SourcePosition;
            Vector3 bossToC = DataM7S.P2_FieldCenter - bossPos;
            switch (accessory.GetMyRole())
            {
                case EX.PlayerRoleEnum.D3:
                    myEndPos = WalkthroughType switch
                    {
                        WalkthroughEnum.MMW_SPJP => new Vector3(0, 0, -24) + DataM7S.P2_FieldCenter,
                        _ => myEndPos,
                    };
                    break;
                case EX.PlayerRoleEnum.D4:
                    myEndPos = WalkthroughType switch
                    {
                        WalkthroughEnum.MMW_SPJP => new Vector3(0.35f * bossToC.X, 0, 0.35f * bossToC.Z) + DataM7S.P2_FieldCenter,
                        _ => myEndPos,
                    };
                    break;
                default:
        ...
        public void P2_KillerSeedsGuideDraw(Event @event, ScriptAccessory accessory)
        {
            ...
            switch (WalkthroughType)
            {
                case WalkthroughEnum.MMW_SPJP:
                    ...
                    {
                        EX.PlayerRoleEnum.MT => groupMT,
                        EX.PlayerRoleEnum.ST => groupST,
                        EX.PlayerRoleEnum.H1 => groupH1,
                        EX.PlayerRoleEnum.H2 => groupH2,
                        EX.PlayerRoleEnum.D1 => groupMT,
                        EX.PlayerRoleEnum.D2 => groupST,
                        EX.PlayerRoleEnum.D3 => groupH1,
                        EX.PlayerRoleEnum.D4 => groupH2,
                        _ => Vector3.Zero
                    };
                    // 绘制指路
        ...
        public void IsLashingLariatCastingCheck(Event @event, ScriptAccessory accessory)
        {
            ...
            */
            ...
            SinisterSeedTargets = new List<ulong>(); // 清空冰花目标
        ...
        public void P3_DebrisDeathmatchGuideDraw(Event @event, ScriptAccessory accessory)
        {
            ...
            switch (accessory.GetMyRole())
            {
                case EX.PlayerRoleEnum.D3:
                    myEndPos = WalkthroughType switch
                    {
                        WalkthroughEnum.MMW_SPJP => new Vector3(0, 0, -17) + DataM7S.P3_FieldCenter,
                        _ => myEndPos,
                    };
                    break;
                case EX.PlayerRoleEnum.D4:
                ...
                case EX.PlayerRoleEnum.H1:
                    myEndPos = WalkthroughType switch
                    {
                        WalkthroughEnum.MMW_SPJP => new Vector3(-17, 0, 0) + DataM7S.P3_FieldCenter,
                        _ => myEndPos,
                    };
                    break;
                case EX.PlayerRoleEnum.H2:
        ...
        public void P3_SinisterSeedsBlossomGuideDraw(Event @event, ScriptAccessory accessory)
        {
            ...
            if (isMeGetSinisterSeed)
            {
                ...
                else
                {
                    ...
                    {
                        case WalkthroughEnum.MMW_SPJP:
                            endPos = accessory.GetMyRole() switch
                            {
                                EX.PlayerRoleEnum.MT => new Vector3(-10, 0, -10) + DataM7S.P3_FieldCenter,
                                EX.PlayerRoleEnum.ST => new Vector3(10, 0, -10) + DataM7S.P3_FieldCenter,
                                EX.PlayerRoleEnum.D1 => new Vector3(-10, 0, 10) + DataM7S.P3_FieldCenter,
                                EX.PlayerRoleEnum.D2 => new Vector3(10, 0, 10) + DataM7S.P3_FieldCenter,
                                _ => Vector3.Zero
                            };
                            break;
                    }
